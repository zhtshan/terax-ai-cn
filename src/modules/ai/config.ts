...
export const MODELS = [
  ...
  },
  {
    ...
    label: "Grok 4 Fast",
    hint: "推理",
    description: "更便宜的 Grok 4，带视觉与推理。",
    capabilities: { intelligence: 4, speed: 4, cost: 4 },
  ...
  },
  {
    ...
    hint: "编程",
    description:
      "面向代理工作流的专用快速编程模型（驱动 Grok Build CLI）。",
    capabilities: { intelligence: 4, speed: 5, cost: 4 },
    tags: ["tools", "coding"],
  },
  ...
  // ── Mistral ────────────────────────────────────────────────────────────────
  {
    ...
    hint: "最佳",
    description: "Mistral 旗舰模型，128K 上下文。",
  ...
  // ── Cerebras (autocomplete-tier) ──────────────────────────────────────────
  {
    ...
    label: "GPT-OSS 120B",
    hint: "超快",
    description: "Cerebras 晶圆级芯片上的最快推理。",
    capabilities: { intelligence: 4, speed: 5, cost: 4 },
    tags: ["tools", "coding"],
  },
  {
  ...
  // ── OpenRouter (gateway; model id is user-supplied at runtime) ────────────
  {
    ...
    label: "OpenRouter",
    hint: "可配置",
    description: "按 id 使用 OpenRouter 上的任意模型。",
  ...
  // ── LM Studio (local; model id is user-supplied at runtime) ───────────────
  {
    ...
    label: "LM Studio",
    hint: "本地",
    description: "通过 LM Studio 使用本地 GGUF 模型。",
  ...
  // ── MLX (local; Apple-silicon; model id is user-supplied at runtime) ──────
  {
    ...
    label: "MLX",
    hint: "本地",
    description: "通过 mlx_lm.server 使用 Apple 芯片模型。",
    capabilities: { intelligence: 3, speed: 3, cost: 5 },
  },
