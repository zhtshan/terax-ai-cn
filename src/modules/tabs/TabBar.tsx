                          ...
                          >
                            ...
                            <div className="flex flex-1 flex-col">
                              ...
                              <span className="text-[10px] text-muted-foreground italic">
                                {tr('tabs.mode', { name: resolveDisplayName(t.title) })}
                              </span>
                            </div>
          ...
          >
            <DropdownMenuItem onSelect={() => onNew()}>
              <HugeiconsIcon
                ...
                strokeWidth={1.75}
              />
              <span className="flex-1">{tr('tabs.terminal')}</span>
            ...
            <DropdownMenuItem onSelect={() => onNewBlock()}>
              <HugeiconsIcon
                ...
                strokeWidth={1.75}
              />
              <span className="flex-1">{tr('tabs.blocks')}</span>
              <span className="text-xs text-muted-foreground">
            ...
            <DropdownMenuItem onSelect={() => onNewPrivate()}>
              <HugeiconsIcon
                ...
                strokeWidth={1.75}
              />
              <span className="flex-1">{tr('tabs.privacy')}</span>
              <span className="text-xs text-muted-foreground">
            ...
            <DropdownMenuItem onSelect={() => onNewEditor()}>
              <HugeiconsIcon
                ...
                strokeWidth={1.75}
              />
              <span className="flex-1">{tr('tabs.editor')}</span>
              <span className="text-xs text-muted-foreground">
            ...
            <DropdownMenuItem onSelect={() => onNewPreview()}>
              ...
              <span className="flex-1">{tr('tabs.preview')}</span>
              <span className="text-xs text-muted-foreground">
            ...
            <DropdownMenuItem onSelect={() => onNewGitGraph()}>
              <HugeiconsIcon
                ...
                strokeWidth={1.75}
              />
              <span className="flex-1">{tr('tabs.gitGraph')}</span>
            </DropdownMenuItem>
          </DropdownMenuContent>
        </DropdownMenu>
      </div>
