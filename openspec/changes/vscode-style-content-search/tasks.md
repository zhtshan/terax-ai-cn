...
- [x] `cargo nextest run --locked` (fallback: `cargo test --locked` per TERAX.md)
...
- [x] 新增 `src/modules/search/index.ts` 公开导出
...
- [x] 新增 `src/modules/search/SearchPanel.tsx`：组合上述组件的主面板
